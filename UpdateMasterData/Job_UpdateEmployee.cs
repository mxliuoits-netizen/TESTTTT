...
{
    public class Job_UpdateEmployee : BaseJob
    {
        #region 設定全域變數
        ...
        public Job_UpdateEmployee(string jobName, Logger logger, params string[] args)
        ...
        public override void Execute()
        {
            ...
            try
            {
                ...
                //s_Modul_DBLogMsg = "更新員工資料開始";

                //sql_Par = new SqlParameter[4];
                ...
                //da.ExecuteProcdure("sp_UpdateEmployee", sql_Par);
                ...
                var sql = da.GetCallSPSQL("sp_UpdateWorkflow", param);
                ...
                da.ExecuteProcdure("sp_UpdateWorkflow", sql_Par);*/
                this.WriteLog("更新簽核流程資料結束", false);

                #endregion

                #region 更新[組織管理人員]資料

                //s_Modul_DBLogMsg = "更新組織管理人員資料開始";
                ...
                //da.ExecuteProcdure("sp_UpdateOrganizationOwner", sql_Par);
                //this.WriteLog("更新組織管理人員資料結束", false);
            ...
            {
                this.CurrentJobStepText = s_Modul_DBLogMsg;
                this.CurrentJobSubStepText = s_DBLogMsg;
                throw; 
            }
        }
        #endregion 主程式
